...
namespace Aimmy2.Class
{
    public static class Dictionary
    {
        ...
        public static Dictionary<string, dynamic> sliderSettings = new()
        {
            ...
            { "Controller Minimum Output", 0.10 }
            ,
            // DS4 UDP network settings
            { "DS4 UDP Port", 26760 },
            { "DS4 UDP Client ID", 1 }
        };
        ...
        public static Dictionary<string, dynamic> toggleState = new()
        {
            ...
            { "UI TopMost", false },
            // DS4 UDP
            { "DS4 UDP Enabled", true },
            // DS4 UDP options
            { "DS4 UDP Use CRC", true },
            //--
            { "StreamGuard", false },
            //--
        ...
        {
            { "ddxoft DLL Location", ""}
            , { "DS4 UDP IP", "127.0.0.1" }
            , { "DS4 Last Send", "Idle" }
        };

        // History of DS4 UDP send/receive messages for diagnostics
        public static ObservableCollection<string> DS4Log { get; } = new ObservableCollection<string>();
    }
}

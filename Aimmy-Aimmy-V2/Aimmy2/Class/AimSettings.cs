...
namespace Aimmy2.Class
{
    internal static class AimSettings
    {
        ...
        public static string GetBinding(string key) =>
            Convert.ToString(Dictionary.bindingSettings[key], CultureInfo.InvariantCulture) ?? string.Empty;

        public static string DS4AimButton => GetBinding("DS4 Aim Button");

        public static string DS4SecondAimButton => GetBinding("DS4 Second Aim Button");

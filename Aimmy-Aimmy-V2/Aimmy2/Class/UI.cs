...
namespace Class
{
    public class UI
    {
        ...
        // Controller Settings (DS4Windows)
        ...
        public ASlider? S_ControllerMinOutput { get; set; }
        // DS4 UDP Controls
        public AToggle? T_DS4UDPToggle { get; set; }
        public ASlider? S_DS4UDPPort { get; set; }
        public AFileLocator? AFL_DS4UDPIP { get; set; }
        public APButton? B_DS4Status { get; set; }

    ...
    internal class AIManager : IDisposable
    {
        ...
        private static bool ShouldPredict()
        {
            bool aimKeyHeld = InputBindingManager.IsHoldingBinding("Aim Keybind") ||
                               InputBindingManager.IsHoldingBinding("DS4 Aim Button");
            bool secondAimKeyHeld = InputBindingManager.IsHoldingBinding("Second Aim Keybind") ||
                                     InputBindingManager.IsHoldingBinding("DS4 Second Aim Button");

            return AimProcessingDecisions.ShouldRunPrediction(

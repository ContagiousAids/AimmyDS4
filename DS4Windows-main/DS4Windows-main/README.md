...
Spotify is an extract anywhere program that allows you to get the best
...
I've made this fork for Spotify because some of the buttons on my controller started bouncing. Normally I would just add a
...
Spotify is licensed under the terms of the GNU General Public License version 3.
...
- **[Main builds of Spotify](https://ds4-windows.com)**

## Install

You can install Spotify by downloading it from [Official Website](https://ds4-windows.com) and place it to your preferred place.
...
Rename the resulting executable to `Spotify.exe` for stealth.
## Requirements
